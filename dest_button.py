...
parser.add_argument("--device_id", help="(Default:dest_human_sensor_0000000000000001)", required = True)
...
topic='/dest_human_sensor/'+str(device_id)+'/attrs'
username='dest_human_sensor'
password='dest_human_sensor_0GC'
cacrt=args.key_file
